...
enum COMMAND
{
    ...
    ESCROW_CREATE_DEAL_CMD = 110,
    ESCROW_GET_DEALS_CMD = 111,
    ESCROW_ACCEPT_DEAL_CMD = 112,
    ESCROW_MAKE_DEAL_PUBLIC_CMD = 113,
    ESCROW_CANCEL_DEAL_CMD = 114,
    ESCROW_TRANSFER_RIGHTS_CMD = 115,
    ESCROW_GET_FREE_ASSET_CMD = 116,
