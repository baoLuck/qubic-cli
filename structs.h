...
enum COMMAND
{
    ...
    QBOND_STAKE_CMD = 110,
    QBOND_TRANSFER_CMD = 111,
    QBOND_ADD_ASK_ORDER_CMD = 112,
    QBOND_REMOVE_ASK_ORDER_CMD = 113,
    QBOND_ADD_BID_ORDER_CMD = 114,
    QBOND_REMOVE_BID_ORDER_CMD = 115,
    QBOND_BURN_QU_CMD = 116,
    QBOND_UPDATE_CFA_CMD = 117,
    QBOND_GET_FEES_CMD = 118,
    QBOND_GET_EARNED_FEES_CMD = 119,
    QBOND_GET_EPOCH_INFO_CMD = 120,
    QBOND_GET_ORDERS_CMD = 121,
    QBOND_GET_USER_ORDERS_CMD = 122,
    QBOND_GET_TABLE_CMD = 123,
    QBOND_GET_USER_MBONDS_CMD = 124,
    QBOND_GET_CFA_CMD = 125,
