...
enum COMMAND
{
    ...
    ESCROW_CREATE_DEAL_CMD = 149,
    ESCROW_GET_DEALS_CMD = 150,
    ESCROW_ACCEPT_DEAL_CMD = 151,
    ESCROW_MAKE_DEAL_PUBLIC_CMD = 152,
    ESCROW_CANCEL_DEAL_CMD = 153,
    ESCROW_TRANSFER_RIGHTS_CMD = 154,
    ESCROW_GET_FREE_ASSET_CMD = 155,
