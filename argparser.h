...
void print_help()
{
    ...
    printf("\t\t<OFFERED_ASSETS> in format name1,issuer1,amount1:name2,issuer2,amount2... Minimum 1 asset, maximum 4 assets.\n");
    printf("\t\t<REQUESTED_ASSETS> in format name1,issuer1,amount1:name2,issuer2,amount2... Minimum 1 asset, maximum 4 assets.\n");
